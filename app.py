...
st.set_page_config(page_title="NYWG Subordinate Unit TLC Compliance Checker", layout="wide")
st.title("Civil Air Patrol - NYWG Subordinate Unit TLC Compliance Checker")
...
# === CONFIG ===
TLC_FILE = "TLC_Progression.csv"
CSV_OUTPUT = "NYWG_TLC_Compliance_Report.csv"
PDF_OUTPUT = "NYWG_TLC_Compliance_Report.pdf"
EXPIRATION_YEARS = 4

# === Embedded Unit Reference ===
unit_reference_data = [
